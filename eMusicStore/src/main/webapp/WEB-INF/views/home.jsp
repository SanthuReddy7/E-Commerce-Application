        ...
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Welcome to Santhu's Music Store</h1>
                    <p>Here you can browse and buy instruments,Records and music related Accessories. Order now for your amazing tool kit!</p>
                </div>
            </div>
        </div>
        <div class="item">
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <h2>Heading</h2>
            <p>sdhghwuiguig uihuigthgriu urh uuiuiw h uiuhtuiw huihutiht uiuiwiuiqe e  uihuiti uiu i</p>
